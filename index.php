...
<h2>Estudiantes</h2>
<?php
$estudiantes = array_map('str_getcsv', file('libs/estudiantes.csv'));
...
<img src="images/establecimientos.png" class="img-responsive">
...
<img src="images/procedencias.png" class="img-responsive">
...
<img src="http://4.bp.blogspot.com/-yCRupeL6o-Y/TeQbIzDyGAI/AAAAAAAAApU/WWvTVshGhx4/s320/Pantallazo-10.png" class="img-responsive">
</section>
<?php include('pie.php');?>
